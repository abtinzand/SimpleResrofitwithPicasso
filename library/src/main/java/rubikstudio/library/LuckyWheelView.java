...
public class LuckyWheelView extends RelativeLayout implements PielView.PieRotateListener {
    ...
    /**
     * @param ctx        ivCursorView = frameLayout.findViewById(R.id.cursorView);
    ...
    private void init(Context ctx, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mBackgroundColor = typedArray.getColor(R.styleable.LuckyWheelView_lkwBackgroundColor, 0xb92835);
